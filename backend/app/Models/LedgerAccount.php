...
class LedgerAccount extends Model {
    ...
    protected $fillable = ['account_number', 'name', 'type', 'customer_id', 'location_id', 'territory_id', 'price_list_version_id', 'sales_officer_id', 'credit_limit', 'opening_balance', 'current_balance', 'is_active', 'created_by', 'price_category_id'];
    ...
    public function priceCategory(): BelongsTo { return $this->belongsTo(PriceCategory::class); }
}
